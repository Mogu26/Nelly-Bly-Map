               ...
               '<details style="cursor: pointer; margin-bottom: 10px;">' +
                ...
                '<details style="cursor: pointer; margin-bottom: 10px;">' +
                    ...
                    '<ul style="font-family: \'Courier New\', monospace; font-size: 0.85rem; margin-top: 10px; color: #2c2416; line-height: 1.6; padding-left: 20px;">' +
                        ...
                        '<br>' +
                        '<li><b>El Español (2016).</b> <i>Retrato histórico de Nellie Bly</i>. <a href="https://s2.elespanol.com/2016/05/20/cultura/historia-mujeres-cultura_126247917_5164887_1706x1280.jpg" target="_blank" style="color: #5a1a1a; font-weight: bold;">[Fotografía]</a>.</li>' +
                        '<br>' +
